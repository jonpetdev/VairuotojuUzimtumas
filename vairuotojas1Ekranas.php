		...
		while($row=mysqli_fetch_array($result)){
			...
			if($row['darbas']=='dirba'){
				...
				if($row['aktyvus']=='vair'){
					...
					echo "<div ><iframe class='uzsakymas1' src='frame2.php' onload='resizeIframe(this)' scrolling='no' frameborder='no'  > </iframe></div>";
					echo "<div ><iframe class='uzsakymas2' src='frame2_2.php' onload='resizeIframe(this)' scrolling='no' frameborder='no'  > </iframe></div>";

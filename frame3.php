    ...
    var x = setInterval(function() {
		...
		<?php
			...
			if($row['laikas'] < $time and $countas=='1'){
				$vienas=$conn->query("UPDATE vairuotojai_uzim SET laikas = '' WHERE id='2'");
				$du=$conn->query("UPDATE vairuotojai_uzim SET uzsakymas1 = 'free' WHERE id='2'");
				$trys=$conn->query("UPDATE vairuotojai_uzim SET countas = '3' WHERE id='2'");

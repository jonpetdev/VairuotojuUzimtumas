		...
		while($row=mysqli_fetch_array($result)){
			...
			if($row['darbas']=='dirba'){
				...
				if(isset($_POST['uz1b'])){	
					...
					mysql_query("UPDATE vairuotojai_uzim SET uzsakymas1 = 'free' WHERE id='$_POST[id]'")or die(mysql_error());
					mysql_query("UPDATE vairuotojai_uzim SET laikas = '' WHERE id='$_POST[id]'")or die(mysql_error());
					mysql_query("UPDATE vairuotojai_uzim SET countas = '1' WHERE id='$_POST[id]'")or die(mysql_error());
					echo "<meta http-equiv='refresh' content='0'>";
				}
				if(isset($_POST['uz1f'])){	
					$resul=mysql_query("UPDATE vairuotojai_uzim SET uzsakymas1 = 'busy' WHERE id='$_POST[id]' ")or die(mysql_error());
					echo "<meta http-equiv='refresh' content='0'>";
				}

    ...
    var x = setInterval(function() {
		...
		<?php
			...
			if($row['laikas2'] < $time and $countas2=='1'){
				$vienas=$conn->query("UPDATE vairuotojai_uzim SET laikas2 = '' WHERE id='3'");
				$du=$conn->query("UPDATE vairuotojai_uzim SET uzsakymas2 = 'free' WHERE id='3'");
				$trys=$conn->query("UPDATE vairuotojai_uzim SET countas2 = '3' WHERE id='3'");
